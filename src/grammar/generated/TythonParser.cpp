  	20,0,225,223,1,0,0,0,225,224,1,0,0,0,226,43,1,0,0,0,227,228,7,3,0,0,228,
  	45,1,0,0,0,28,49,55,62,71,76,82,94,98,102,107,114,118,124,141,143,146,
  	153,155,158,165,167,170,184,192,198,213,220,225
  };
...
//----------------- Lbl_attribute_accessContext ------------------------------------------------------------------

std::vector<TythonParser::LvalContext *> TythonParser::Lbl_attribute_accessContext::lval() {
  return getRuleContexts<TythonParser::LvalContext>();
}

TythonParser::LvalContext* TythonParser::Lbl_attribute_accessContext::lval(size_t i) {
  return getRuleContext<TythonParser::LvalContext>(i);
}

tree::TerminalNode* TythonParser::Lbl_attribute_accessContext::SYM_DOT() {
  return getToken(TythonParser::SYM_DOT, 0);
}

TythonParser::Lbl_attribute_accessContext::Lbl_attribute_accessContext(LvalContext *ctx) { copyFrom(ctx); }


std::any TythonParser::Lbl_attribute_accessContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<TythonParserVisitor*>(visitor))
    return parserVisitor->visitLbl_attribute_access(this);
  else
    return visitor->visitChildren(this);
}
//----------------- Lbl_array_accessContext ------------------------------------------------------------------

tree::TerminalNode* TythonParser::Lbl_array_accessContext::IDENTIFIER() {
  return getToken(TythonParser::IDENTIFIER, 0);
}

tree::TerminalNode* TythonParser::Lbl_array_accessContext::SYM_LSQ() {
  return getToken(TythonParser::SYM_LSQ, 0);
}

TythonParser::LvalContext* TythonParser::Lbl_array_accessContext::lval() {
  return getRuleContext<TythonParser::LvalContext>(0);
}

tree::TerminalNode* TythonParser::Lbl_array_accessContext::SYM_RSQ() {
  return getToken(TythonParser::SYM_RSQ, 0);
}

TythonParser::Lbl_array_accessContext::Lbl_array_accessContext(LvalContext *ctx) { copyFrom(ctx); }


std::any TythonParser::Lbl_array_accessContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<TythonParserVisitor*>(visitor))
    return parserVisitor->visitLbl_array_access(this);
  else
    return visitor->visitChildren(this);
}
...
TythonParser::LvalContext* TythonParser::lval(int precedence) {
  ParserRuleContext *parentContext = _ctx;
  size_t parentState = getState();
  TythonParser::LvalContext *_localctx = _tracker.createInstance<LvalContext>(_ctx, parentState);
  TythonParser::LvalContext *previousContext = _localctx;
  (void)previousContext; // Silence compiler, in case the context is not used by generated code.
  size_t startState = 40;
  enterRecursionRule(_localctx, 40, TythonParser::RuleLval, precedence);
  ...
  try {
    ...
    case 2: {
      _localctx = _tracker.createInstance<Lbl_array_accessContext>(_localctx);
      _ctx = _localctx;
      previousContext = _localctx;
      setState(208);
      match(TythonParser::IDENTIFIER);
    ...
    while (alt != 2 && alt != atn::ATN::INVALID_ALT_NUMBER) {
      if (alt == 1) {
        if (!_parseListeners.empty())
          triggerExitRuleEvent();
        previousContext = _localctx;
        auto newContext = _tracker.createInstance<Lbl_attribute_accessContext>(_tracker.createInstance<LvalContext>(parentContext, parentState));
        _localctx = newContext;
        newContext->instance = previousContext;
        ...
        match(TythonParser::SYM_DOT);
        setState(217);
        antlrcpp::downCast<Lbl_attribute_accessContext *>(_localctx)->attribute = lval(0); 
      }
      setState(222);
      _errHandler->sync(this);
      alt = getInterpreter<atn::ParserATNSimulator>()->adaptivePredict(_input, 26, _ctx);
...
bool TythonParser::lvalSempred(LvalContext *_localctx, size_t predicateIndex) {
  switch (predicateIndex) {
